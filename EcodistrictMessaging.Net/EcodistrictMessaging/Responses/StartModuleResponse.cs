...
namespace Ecodistrict.Messaging.Responses
{
    ...
    /// <seealso cref="ModuleResult"/>
    [DataContract]
    public class CopyOfStartModuleResponse : Response
    {
        /// <summary>
        /// The kpi id that this response refers to.
        /// </summary>
        ...
        internal CopyOfStartModuleResponse() { }
        ...
        /// <param name="status">Status indicator</param>
        /// <param name="info">Optional info regarding the status.</param>
        public CopyOfStartModuleResponse(string moduleId, string variantId, string userId, string kpiId, ModuleStatus status, string info = null)
        {
            this.method = "startModule";
            this.type = "response";
            this.moduleId = moduleId;
    ...
    /// state of the module.
    /// </summary>
    public enum CopyOfModuleStatus
    {
        /// <summary>
        /// The module is calculating. 
        /// </summary>
