...
namespace Ecodistrict.Messaging.Responses
{
    ...
    /// <seealso cref="Serialize"/>
    [DataContract]
    public class CopyOfGetModulesResponse : Response
    {
        /// <summary>
        /// Name of the Module, will be visualized in the dashboard.
        /// </summary>
        ...
        internal CopyOfGetModulesResponse() { }
        ...
        /// <param name="description">A description of the Module that will be visualized in the dashboard.</param>
        /// <param name="kpiList">A list of kpis that the Module can calculate.</param>
        public CopyOfGetModulesResponse(string name, string moduleId, string description,
            List<string> kpiList)
        {
            this.method = "getModules";
            this.type = "response";
