...
namespace Ecodistrict.Messaging
{
    ...
    /// that the message it produces when you <see cref="Serialize"/> it can be interpreted by the dashboard. 
    ...
    /// the dashboard there is at least one <see cref="Response"/> you should send back. If you get a moduleId, variantId
    ...
    /// <br/>
    /// Received: <see cref="GetModulesRequest"/>  => Respond: <see cref="GetModulesResponse"/><br/>
    /// <br/>
    /// Received: <see cref="SelectModuleRequest"/>  and moduleId is my id => Respond:  <see cref="SelectModuleResponse"/> 
    ...
    /// 'Success' (if it is, otherwise 'Failure'). Then send result with <see cref="ModuleResult"/>.<br/>
    /// <br/>
    /// <br/>
